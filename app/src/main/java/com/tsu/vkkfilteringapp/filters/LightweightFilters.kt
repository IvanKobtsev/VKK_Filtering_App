...
class LightweightFilters {
                ...
                async(Dispatchers.Default) {
                    for (i in rows) {
                        for (j in 1 until img.width - 1) {
                            ...
                            newImgArray[iter] =
                                Color.rgb(
                                    toRange(255, 0, (Color.red(imgArray[iter])-128)*ratio+128),
                                    toRange(255, 0, (Color.green(imgArray[iter])-128)*ratio+128),
                                    toRange(255, 0, (Color.blue(imgArray[iter])-128)*ratio+128)
                                )
                        ...
                        for (j in radius until img.width - radius) {
                            ...
                            for (coreI in i - radius until i + radius) {
                                ...
                                for (coreJ in j - radius until j + radius) {
                                    ...
                                    localJ++
                                    //Log.e("huynu","core "+  core[localI][localJ])
                                    //Log.e("huynu","i "+  localI)
                                    //Log.e("huynu","j "+  localI)
                                }
                                localI++
                            }
                            //Log.e("huynu","red "+ red)
    ...
    private fun findCompromise(
        color: Int, type: Int,
        oldColor: Int, compromise: Double
    ): Int {
